...
if($purpose == 'list') {
	...
	$data_w = $this->Board_model->gets(25);
	$data_w_info = $this->Board_model->gets_info(25, 10);
	...
	if($this->is_mobile()) {
		...
		$this->load->view('MOBILE/menu/top_menu');
			$this->load->view('MOBILE/board/list_page', array("data_w"=> $data_w, "data_w_info"=> $data_w_info, "function_name" => $this->Board_model->call_function_name(), "sblst_info" => $sblst_info ));
	...
	$this->load->view('PC/menu/top_menu');
		$this->load->view('PC/board/list_page', array("data_w"=> $data_w, "data_w_info"=> $data_w_info, "function_name" =>  $this->Board_model->call_function_name(), "sblst_info" => $sblst_info ));
	...
	if($this->is_mobile()) {
		...
		$this->load->view('MOBILE/board/header_board_page');
		$this->load->view('MOBILE/menu/top_menu');
			$this->load->view('MOBILE/board/read_page', array("data_w_read"=>$data_w_read, "data_c"=>$data_c, "data_w"=>$data_w, "data_w_info"=> $data_w_info, "function_name" => $this->Board_model->call_function_name(), "check_gallery" => 0, "sblst_info"=> $sblst_info ));
		$this->load->view('MOBILE/board/footer_board_page');
		$this->load->view('MOBILE/end_page');
		return 0;
	}
	...
	$this->load->view('PC/board/header_board_page');
	$this->load->view('PC/menu/top_menu');
		$this->load->view('PC/board/read_page', array("data_w_read"=>$data_w_read, "data_c"=>$data_c, "data_w"=>$data_w, "data_w_info"=> $data_w_info, "function_name" => $this->Board_model->call_function_name(), "check_gallery" => 0, "sblst_info"=> $sblst_info ));
	$this->load->view('PC/board/footer_board_page');
	$this->load->view('PC/end_page');
...
}  else if ($purpose == 'qaasolveinfo') {
	$this->load->model('Board_model');
	$this->Board_model->qaa_solve_info();
	
}  else if ($purpose == 'selectanswer') {
	$this->load->model('Board_model');
	$this->Board_model->select_answer();
