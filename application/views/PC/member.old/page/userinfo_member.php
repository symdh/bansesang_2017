			...
			<table id = "pgUi_TBstl_info">
				<tbody>
					...
					<tr>
						...
						<td> 
							<button style = 'font-size:12px; margin-top: 10px;' onclick = "$('#pgUi_Dstl_modifyPasswd').show();">비밀번호 변경</button>
							
							<div style ='margin-top: 10px; display:none;' id = 'pgUi_Dstl_modifyPasswd'>
								<form method="post" onsubmit="return check_passwd_form();" action='/member/userpage/modifypasswd'>
									...
									<br>
									<span class = "C_style_input_1" style = 'padding-left: 80px; color:gray;' name = 'alert_pwd' >*비밀번호를 한번 더 입력해주세요.</span>
...
<script>
	...
	function reset_passwd(){
		$('span[name=alert_pwd]').css('color','gray');
	...
	function check_passwd_form () {
		...
		return true;
					...
					<tr>
						...
						<td> 
							<button style = 'font-size:12px; margin-top: 10px;' onclick = "$('#pgUi_Dstl_modifyImg').show();">사진변경</button>
							...
							<div style ='margin-top: 10px; display:none;' id = 'pgUi_Dstl_modifyImg'>
								...
								<form method="post" action='/member/userpage/modifyimg' enctype="multipart/form-data">
									...
									<span>
										...
										*사진삭제를 원하면 파일선택을 하지 않고 제출하면 됩니다.
					...
					<tr>
						...
						<td> 
							<button style = 'font-size:12px; margin-top: 10px;' onclick = "$('#pgUi_Dstl_contentIntro').hide(); $('#pgUi_Dstl_modifyIntro').show();">소개변경</button>

							<div style = 'width:350px; margin-top: 10px;' id = 'pgUi_Dstl_contentIntro'>
								<?=$user_info['user_intro']?>
							</div>

							<div style = 'width:350px; height:100px; display:none;' id = 'pgUi_Dstl_modifyIntro'>
								...
								<form method="post" action='/member/userpage/modifyIntro'>
									...
									<div style = 'display : block; width:400px; height:80px;'>
										<textarea class='C_txtr-W500' style = 'width:400px; height:80px; ' size="40" maxlength="500" name="user_introduce"><?=$user_info['user_intro']?></textarea>
