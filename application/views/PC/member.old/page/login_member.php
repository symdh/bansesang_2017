...
$(document).ready(function(){
	...
	function check_login_info() {
		//이메일 체크
		if(!watch_email ('user_email_id', 0, '', 6, 0) ) {
						...
						<tr>
							<td colspan="2">
								<span style = "float:right;" class = 'C_height_full'>
									이메일 : <input type='text' name='user_email_id'  placeholder="이메일를 입력하세요" size='25' onkeydown = "if(window.event.keyCode == 9){ $('input[name=user_passwd]').focus(); return false;}" >
								</span>
							</td>
