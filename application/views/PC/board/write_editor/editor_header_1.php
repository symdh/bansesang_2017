...
if($function_name != 'csc' && !preg_match( '/minfo/',$function_name) ){
	echo "<form name='tx_editor_form' id='tx_editor_form' action='/board/{$function_name}/uploadwrite' method='post' accept-charset='utf-8'>";
} else { 
	echo "<form name='tx_editor_form' id='tx_editor_form' action='/{$function_name}/uploadwrite' method='post' accept-charset='utf-8'>";
}
...
?>
		...
		<div>
			<br>
			<input name = "title" id = "brdWrt_Dplec_WrtTtl" placeholder = "제목을 입력하세요"> </input>
<?php
