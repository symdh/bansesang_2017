				...
				<input type='hidden' name='<?=$this->security->get_csrf_token_name()?>' value='<?=$this->security->get_csrf_hash()?>' />
					<table>
						...
						<tr>
							<td colspan="2">
									<span style = "float:right;" class = 'C_height_full'>
										이메일 : <input  style = 'max-width:200px;' type='text' name='user_email_id'  placeholder="이메일을 입력하세요." size='25'  >
									</span>
						...
						<tr>
							<td colspan="2">
								<span style = "float:right;" class = 'C_height_full' >
									이름 : <input style = 'max-width:200px;' type='text' name='user_name' placeholder="이름을 입력하세요" size='25'>
								</span>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<span style = "float:right;" class = 'C_height_full' >
									핸드폰번호 : <input style = 'max-width:200px;' type='text' name='user_phone' placeholder="특수문자 - 제외" size='25'>
								</span>
							</td>
						</tr>
