				...
				<input type='hidden' name='log_c' value='<?=$data[0]['auth']?>' />
					<table>
						...
						<tr>
							<td colspan="2">
								<span style = "float:right;" class = 'C_height_full' >
									비밀번호 입력 : <input style = 'max-width:200px;' type="password" size="20" name="user_passwd" placeholder="비밀번호 (6자이상)" >
								</span>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<span style = "float:right;" class = 'C_height_full' >
									비밀번호 재입력 : <input style = 'max-width:200px;' type="password" size="20" name="user_passwd2" placeholder="비밀번호 확인" >
								</span>
							</td>
						</tr>
