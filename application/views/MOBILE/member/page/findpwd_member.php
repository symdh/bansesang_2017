				...
				<input type='hidden' name='<?=$this->security->get_csrf_token_name()?>' value='<?=$this->security->get_csrf_hash()?>' />
					<table>
						...
						<tr>
							<td colspan="2">
									<span style = "float:right;" class = 'C_height_full'>
										아이디 : <input  style = 'max-width:200px;' type='text' name='user_email_id'  placeholder="아이디를 입력하세요." size='25'  >
									</span>
						...
						<tr>
							<td colspan="2">
								<span style = "float:right;" class = 'C_height_full' >
									가입시 입력한 이름 : <input style = 'max-width:200px;' type='text' name='user_name' placeholder="가입시 입력했던  가장 친한 친구이름" size='25'>
								</span>
							</td>
						</tr>
